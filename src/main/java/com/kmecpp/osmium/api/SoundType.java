...
public enum SoundType {
	...
	static {
		//TODO: Abstract this to an enum delegator. BlockType,ItemType,SoundType
		Field sourceField;
		try {
			sourceField = SoundType.class.getDeclaredField("source");
		...
		for (SoundType type : values()) {
			try {
				if (Platform.isBukkit()) {
					...
					for (Field field : SoundTypes.class.getFields()) {
